...
fs.ensureDir(home)
.then(() => {writeFile(newFilePath,req.body)})
...
app.get("/all", function (req, res) {
  ...
  res.send(`<html><body><head><style>body, a{font-family:sans-serif;font-size:80%;}</style></head><h1>Seeds 🌱</h1><br>${fileList}</body></html>`);
});
